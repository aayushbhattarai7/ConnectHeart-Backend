...
const Post: React.FC<PostProps> = ({ postId, refresh }) => {
    ...
    const { register, reset, formState: { isSubmitting } } = useForm<FormData>();
    ...
    return (
        ...
        <div className='flex flex-col justify-center items-center w-lgx p-6'>
            ...
            <form onSubmit={handleSubmit} noValidate encType="multipart/form-data" className='w-full max-w-lg bg-white p-8 rounded-lg shadow-md justify-center items-center'>
