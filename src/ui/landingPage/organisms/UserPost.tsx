    ...
    const renderComments = (comments: Comment[], isChild: boolean = false) => {
        ...
        return (comments.map(cmt => (
            ...
            <div key={cmt?.id} className='flex justify-start items-center'>
                <div key={cmt.id} className={`relative mb-4 ${isChild ? 'ml-7' : 'ml-4'} p-4 rounded-md bg-gray-50 shadow-sm `}>
                    {isChild && (
    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-start mt-60 w-maxx items-center overflow-hidden ml-56'>
                ...
                {error && <p>{error}</p>}
                {posts.map(post => (
                    <div className='shadow-xl   p-10 mb-16 bg-gray-100' style={{
                        ...
                        <div key={post.postIt?.id} className='bg-white  mb-5'>
                            <div className='flex bg-gray-100'>
                                ...
                                <img className="w-16 h-16  rounded-full " src="/profilenull.jpg" alt="Default Profile" />
                            )}
                                </div>
