  ...
  return (
    <div className=' '>
      ...
      bg-[#f3f4f6] font-poppins '>
        <div className=' shadow-[0_4px_6px_rgba(128,128,128,0.5)] bg-white
       p-9 rounded-lg flex flex-col justify-center items-center pl-20'>
          ...
          <div className='flex gap-3 border rounded-lg  w-googlew mr-16 p-3 
          justify-center mb-9'>
          ...
          <div className='pr-10 relative mb-8'>
            ...
            <p className='text-gray-400  bg-white ml-24 top-1  
            absolute'>or login with email</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className=''>
            ...
            <div className='flex gap-20 mr-10 mb-7'>
              ...
              <Link className='text-blue-800' to={''}>Forget Password?</Link>
            </div>

            <div className=''>
              <Button buttonText={authLabel.login[lang]} name='' type="submit"
                disabled={isSubmitting} className={'w-[22rem] mb-5  hover:bg-blue-900 '} />
            </div>

          </form>

          <div className='flex w-[25rem]'>
            <Link className='flex text-blue-800  ' to={'/signup'}>Not registered yet?
              <MdOutlineArrowOutward /></Link>
            <Link to={''}></Link>
