           ...
           <div className=" shadow-lg rounded-lg p-6 max-w-md text-center">
             <div className="text-4xl text-gray-500 mb-4">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-16 h-16 mx-auto">
                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m13 4a9 9 0 11-18 0 9 9 0 0118 0z" />
               </svg>
             </div>
             <h2 className="text-2xl font-semibold text-gray-700">No Connect Request Received Yet</h2>
             <p className="text-gray-600 mt-2">You're all set! We'll notify you once a connect request comes in.</p>
              ...
              >
                <div onClick={() => handleUserClick(request.sender.id)}>
                  <div className="h-44 w-44 mb-5 shadow-2xl">
                    <img
                      className="h-44 w-44 rounded-2xl mb-10"
