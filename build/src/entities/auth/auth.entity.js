...
__decorate([
    (0, typeorm_1.OneToOne)(() => details_entities_1.userDetails, (details) => details.auth, { cascade: true }),
    __metadata("design:type", details_entities_1.userDetails)
], Auth.prototype, "details", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => posts_entity_1.Post, (post) => post.postIt, { cascade: true }),
