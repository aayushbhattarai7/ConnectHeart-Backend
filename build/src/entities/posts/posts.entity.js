...
exports.Post = Post;
__decorate([
    (0, typeorm_1.Column)({ name: 'thought' }),
    __metadata("design:type", String)
], Post.prototype, "thought", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: "feeling" }),
    __metadata("design:type", String)
], Post.prototype, "feeling", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => auth_entity_1.Auth, (postIt) => postIt.posts, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE'
    }),
    (0, typeorm_1.JoinColumn)({ name: 'auth_id' }),
    __metadata("design:type", auth_entity_1.Auth)
], Post.prototype, "postIt", void 0);
