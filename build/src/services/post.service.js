...
class PostService {
  ...
  getAuth
  constructor(
    getPostRepo = database_config_1.AppDataSource.getRepository(posts_entity_1.Post),
    getAuth = database_config_1.AppDataSource.getRepository(auth_entity_1.Auth)
  ) {
  ...
  async create(data, id) {
    ...
    if (!auth) throw HttpException_utils_1.default.notFound(message_1.Message.notFound)
  ...
  async update(data, userId) {
    ...
    if (!post) throw HttpException_utils_1.default.notFound
