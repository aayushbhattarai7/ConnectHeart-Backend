...
router.post(
  '/signup',
  Requestvalidator_1.default.validate(user_dto_1.AuthDTO),
  (0, catchAsync_utils_1.catchAsync)(authController.create)
)
...
router.patch(
  '/update',
  Requestvalidator_1.default.validate(user_dto_1.UpdateDTO),
  (0, catchAsync_utils_1.catchAsync)(authController.update)
)
...
router.post(
  '/',
  fileUpload_1.default.array('file'),
  (0, catchAsync_utils_1.catchAsync)(media_controller_1.default.create)
)
