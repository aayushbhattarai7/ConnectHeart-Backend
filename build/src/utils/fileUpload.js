...
const storage = multer_1.default.diskStorage({
  destination: function (req, _file, cb) {
    let folderPath = ''
    if (!req.body.type) return cb(HttpException_utils_1.default.badRequest('choose a file'), '')
    if (!enum_1.MediaType[req.body.type]) return cb(HttpException_utils_1.default.badRequest('invalid file type'))
    ...
    else folderPath = path_1.default.resolve(process.cwd(), 'public', 'uploads', 'temp')
